    ...
    <div class="signin-signup-div">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="loginaction.php" class="sign-in-form" method="POST">
            <h2 >Sign in</h2>
            ...
            <button name="login" value="" class="btn solid">Login</button>
          ...
          <form action="signupaction.php" class="sign-up-form" method="POST">
            <h2>Sign up</h2>
            <div class="input-field">
              <i class="fas fa-user"></i>
