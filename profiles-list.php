...
include 'db-connect.php';
  ...
  if (!isset($_GET['Page'])){
    ...
    if (isset($search)){
      $sql = "SELECT * FROM signup WHERE username LIKE '%".$search."%'";
    }else{
...
<div class="dashboard-div">
  ...
  <div class="menu">
    <ul>
      <li class="active"><a href="profiles-list.php">Profiles</a></li>
  ...
  ?>
            ...
            <article class="">
                  <a href="#">
                    ...
                    <div class="details">
                      <h1><?php echo $name ?></h1>
                      <h2><?php echo $expertise ?></h2>
                      <p><?php echo $descriptions ?></p>
                      <h3>Date of Birh: <span><?php echo $dob ?></span></h3>
                      <h3>Contact #: <span><?php echo $phone ?></span></h3>
                      <h3>Email: <span><?php echo $email ?></span></h3>
                      <h3>City: <span><?php echo $city ?></span></h3>

                    </div>
                  </a>
                  <a href="delete.php?delete=profile&id=<?php echo $id ?>"><button type="button" name="button"><i class="fas fa-trash-alt"></i></button></a>
                </article>
        ...
        <?php
            ...
            $data_to_send = "profiles-list.php?search=$search&Page=";
            // Rewind button
            if ($Start>1){
              $b_Page = $Page-3;
