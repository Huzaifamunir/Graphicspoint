...
if (!isset($_GET['Page'])){
  ...
  if (isset($search)){
    $sql = "SELECT * FROM contactus WHERE name LIKE '%".$search."%'";
  }else{
...
<div class="dashboard-div">
  ...
  <div class="menu">
    <ul>
      ...
      <li class="active"><a href="messages-list.php">Messages</a></li>
      <hr>
      <li><a href="logout.php">SignOut</a></li>
    </ul>
  </div>
            <div class="detail">
              <h1>Messages <span>List</span></h1>
              ...
              <section class="profiles-list-result messages-list-result">
            ...
            <article class="">
                  <a href="">
                    <div class="details">
                      ...
                      <p><?php echo $msg ?> </p>
                      <h3><span>11/11/1111</span></h3>

                    </div>
                  </a>


                  <a href="delete.php?delete=message&id=<?php echo $id ?>"> <button type="button" name="button"><i class="fas fa-trash-alt"></i></button></a>
                </article>
